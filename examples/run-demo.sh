...
echo "  - TIME: the 'Quarterly Report ... FINAL' near-duplicate was linked to its draft — look"
echo "    for the VERSIONS log line; the draft page now carries superseded_by:, the FINAL page"
echo "    supersedes:, and every page has a provable as_of"
